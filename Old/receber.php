...
<?php
	...
	$listar_envios="SELECT entrega_alb.loja_id, lojas.loja_nome, entrega_alb.os_alb, entrega_alb.data_envio_loja, entrega_alb.status, entrega_alb.data_recebe_lab, entrega_alb.status_receb FROM entrega_alb join lojas on lojas.loja_id=entrega_alb.loja_id and entrega_alb.status_receb='<span class=stat2>Recebido-LAB</span>' order by entrega_alb.data_envio_loja desc";
		...
		while ($lista_de_envios=mysqli_fetch_array($query_envios)){
			...
			$data_recebe_lab=$lista_de_envios['data_recebe_lab'];
			...
			echo"<td>$receber</td>";
			echo"<td id='datalab'>$data_recebe_lab</td>";
			
			echo"<td ><a href='encadernadora.php?os=$os'><img src='imagens/seta.png' width=10px id='bt' ></a></td>";
